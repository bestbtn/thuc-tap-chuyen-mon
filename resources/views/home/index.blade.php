                        ...
                        <div class="block-slideshow__body">
                            <div class="owl-carousel">
                                <a class="block-slideshow__slide" href="#">
                                    <div class="block-slideshow__slide-image block-slideshow__slide-image--desktop" style="background-image: url( {{asset('images/slides/slide-1-full.jpg')}})"></div>
                                ...
                                <a class="block-slideshow__slide" href="#">
                                    <div class="block-slideshow__slide-image block-slideshow__slide-image--desktop" style="background-image: url({{asset('images/slides/slide-2-full.jpg')}})"></div>
                                ...
                                <a class="block-slideshow__slide" href="#">
                                    <div class="block-slideshow__slide-image block-slideshow__slide-image--desktop" style="background-image: url({{asset('images/slides/slide-3-full.jpg')}})"></div>
                                    ...
                                    <div class="block-products-carousel__cell">
                                        <div class="product-card">
                                            ...
                                            <div class="product-card__image">
                                                <a href="product.html"><img src="{{pare_url_file($proHot->pro_avatar)}}" alt=""></a>
                                            </div>
                                            <div class="product-card__info">
                                                <div class="product-card__name"><a href="product.html">{{$proHot->pro_name}}</a></div>
                        ...
                        <div class="block-products-carousel__column">
                            <div class="block-products-carousel__cell">
                                <div class="product-card">
                                    ...
                                    <div class="product-card__image">
                                        <a href="product.html"><img src="{{pare_url_file($proNew->pro_avatar)}}" alt=""></a>
                                    </div>
                                    <div class="product-card__info">
                                        <div class="product-card__name"><a href="product.html">{{$proNew->pro_name}}</a></div>
                                        <div class="product-card__rating">
                                            <div class="rating">
                                                <div class="rating__body">
                                                    <svg class="rating__star rating__star--active" width="13px" height="12px">
        ...
        <div class="block block-banner">
            <div class="container">
                <a href="#" class="block-banner__body">
                    <div class="block-banner__image block-banner__image--desktop" style="background-image: url({{asset('images/banners/banner-1.jpg')}}"></div>
                    <div class="block-banner__image block-banner__image--mobile" style="background-image: url({{asset('images/banners/banner-1-mobile.jpg')}})"></div>
